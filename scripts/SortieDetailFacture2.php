        ...
        <div class="container-imp">
              <div class="row">
               ...
               where L.ID_CO='$ID_CO' AND A.ID_A=L.ID_A  ";
                    ...
                    $sqlquery1 = "SELECT D.ID_CO, D.REF_CO,  D.ID_C, D.DATE_CO, YEAR(D.DATE_CO) AS annee, CL.ID_C, CL.RAISSO_C, CL.ADRESSE_C, CL.ADRESSE1_C, CL.TEL_C, CL.EMAIL, CL.NIF, CL.STAT, DATE_FORMAT(D.DATE_CO, '%d/%m/%Y') AS date_fr
              ...
              WHERE D.ID_CO='$ID_CO'  AND  CL.ID_C=D.ID_C";
                    ...
                    <div class="row">
                        <div class="col-xs-5 ">
                           <h4><strong>Facture <span>N° : <?php echo $row1['REF_CO'] .'/'.$month.'/'.$year?></span></strong></h4>
                        </div> 
