...
//$c=$retour[0];
    ...
    <?php
     ...
     $req = "select *  FROM UNITE ";
              ...
              WHERE  C.ID_DV='$ID_DV' AND A.ID_A=C.ID_A AND A.UNITE='$unite' AND C.RABOT='0' AND C.SEC='0' AND A.ID_TYPE='$type1' order by DESIGNATION ASC";
                    ...
                    ?>
                                                ...
                                                $suppNLC = $suppNLC + $montsupprabot*$rowNLC['VOL'] ;
                                                                }
               ...
               where L.ID_DV='$ID_DV' AND A.ID_A=L.ID_A AND A.UNITE='$unite' AND A.ID_TYPE='$type1'";
                                    ...
                                    $reqNLCR = "SELECT A.UNITE, A.QTE, A.VOL, A.ID_A, A.ID_TYPE, A.DESIGNATION, A.LONGUEUR, A.LARGEUR, A.UNITE, A.EPAISSEUR, A.DIAMETRE, A.PV_HT, A.FAMILLE, A.TYPE, C.ID_DV, C.ID_DV_LIGNE, C.QTE_DV,C.RABOT, C.SEC, (C.QTE_DV*A.QTE)*A.PV_HT as 'MONTANT'
              FROM  ARTICLE A, CONTENIR_DV C
              WHERE  C.ID_DV='$ID_DV' AND A.ID_A=C.ID_A AND A.UNITE='$unite' AND C.RABOT='1' AND C.SEC='0'  AND A.ID_TYPE='$type1' order by DESIGNATION ASC";

                                    $resNLCR = mysqli_query($link, $reqNLCR);
                                    $nombreNLCR = mysqli_num_rows($resNLCR);
                                    if ($nombreNLCR > 0) {
                                        ...
                                        <table class="info saut" border="1" style="width:100%">
                                            <thead>  
                                                <tr class="info">
                                                    <th width="30%"><strong>Produit raboté</strong></th>
                                                    <th width="6%"><strong>Qté</strong></th>
                                                    <th width="7%"><strong>Long</strong></th>
                                                    <th width="7%"><strong>Larg</strong></th>
                                                    <th width="7%"><strong>Ep</strong></th>
                                            ...
                                            $VOLUMENLCR = 0;
                                            $suppNLCR=0;
                                            while ($rowNLCR = mysqli_fetch_array($resNLCR, MYSQLI_ASSOC)) {
                                                        $text= " (Raboté) ";         
                                                ?>
                                                <tr>
                                                    <td><?= $rowNLCR['FAMILLE'].$text ?></td>
                                                    <td><?php echo $rowNLCR['QTE_DV'] ?></td>
                                                    <td><?php echo $rowNLCR['LONGUEUR'] ?></td>
                                                    <td><?php echo $rowNLCR['LARGEUR'] ?></td>
                                                    <td><?php echo $rowNLCR['EPAISSEUR'] ?></td>
                                                    <td></td>
                                                    <td style="text-align:right"> <?php echo number_format($rowNLCR['VOL'] * $rowNLCR['QTE_DV'], 3, ',', ' ') ?></td>
                                                    <td style="text-align:right"><?php echo number_format($rowNLCR['PV_HT'], 0, ',', ' ') . " Ar" ?></td>
                                                    <?php 
                    ...
                    ?>
                                                    ...
                                                    <td style="text-align:right"><?php echo number_format($rowNLCR['MONTANT'], 0, ',', ' ') . " Ar" ?></td>
                                                </tr>
                                                <?php

                                                $VOLUMENLCR = $VOLUMENLCR + $rowNLCR['VOL'] * $rowNLCR['QTE_DV'];
                                                $suppNLCR = $suppNLCR + $montsupprabot*$rowNLCR['VOL']* $rowNLCR['QTE_DV'] ;
                                                                }
                                                                $sqlquery3NLCR = "SELECT  A.UNITE, sum((L.QTE_DV*A.QTE)*A.PV_HT) as 'THT', sum((L.QTE_DV*A.QTE)*A.PV_HT*(1+0.20)) as 'TTC', sum(A.VOL*L.QTE_DV) as 'VOLDV'
               from CONTENIR_DV L, ARTICLE A
               where L.ID_DV='$ID_DV' AND A.ID_A=L.ID_A AND A.UNITE='$unite' AND A.ID_TYPE='$type1'";
                                                                $result3NLCR = mysqli_query($link, $sqlquery3NLCR);
                                                                $row3NLCR = mysqli_fetch_array($result3NLCR, MYSQLI_ASSOC);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($suppNLCR, 0, ',', ' ') . " Ar" ?></strong></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="6" class="success"><strong>Total</strong></td>
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($VOLUMENLCR, 3, ',', ' ') ?></strong></td>
                                                                    <td></td>
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($row3NLCR['THT'] + $suppNLCR, 0, ',', ' ') . " Ar" ?></strong></td>
                                                                </tr>
                                                        </table>
                                                        <?php
}
                                                   
                                    $reqNLCS = "SELECT A.UNITE, A.QTE, A.VOL, A.ID_A, A.ID_TYPE, A.DESIGNATION, A.LONGUEUR, A.LARGEUR, A.UNITE, A.EPAISSEUR, A.DIAMETRE, A.PV_HT, A.FAMILLE, A.TYPE, C.ID_DV, C.ID_DV_LIGNE, C.QTE_DV,C.RABOT, C.SEC, (C.QTE_DV*A.QTE)*A.PV_HT as 'MONTANT'
              FROM  ARTICLE A, CONTENIR_DV C
              WHERE  C.ID_DV='$ID_DV' AND A.ID_A=C.ID_A AND A.UNITE='$unite' AND C.RABOT='0' AND C.SEC='1'  AND A.ID_TYPE='$type1' order by DESIGNATION ASC";

                                    $resNLCS = mysqli_query($link, $reqNLCS);
                                    $nombreNLCS = mysqli_num_rows($resNLCS);
                                    if ($nombreNLCS > 0) {
                                        ...
                                        <table class="info saut" border="1" style="width:100%">
                                            <thead>  
                                                <tr class="info">
                                                    <th width="30%"><strong>Produit sec</strong></th>
                                                    <th width="6%"><strong>Qté</strong></th>
                                                    <th width="7%"><strong>Long</strong></th>
                                                    <th width="7%"><strong>Larg</strong></th>
                                                    <th width="7%"><strong>Ep</strong></th>
                                            ...
                                            $VOLUMENLCS = 0;
                                            $suppNLCS=0;
                                            while ($rowNLCS = mysqli_fetch_array($resNLCS, MYSQLI_ASSOC)) {                                       
                                                ?>
                                                <tr>
                                                    <td><?= $rowNLCS['FAMILLE'].$text ?></td>
                                                    <td><?php echo $rowNLCS['QTE_DV'] ?></td>
                                                    <td><?php echo $rowNLCS['LONGUEUR'] ?></td>
                                                    <td><?php echo $rowNLCS['LARGEUR'] ?></td>
                                                    <td><?php echo $rowNLCS['EPAISSEUR'] ?></td>
                                                    <td></td>
                                                    <td style="text-align:right"> <?php echo number_format($rowNLCS['VOL'] * $rowNLCS['QTE_DV'], 3, ',', ' ') ?></td>
                                                    <td style="text-align:right"><?php echo number_format($rowNLCS['PV_HT'], 0, ',', ' ') . " Ar" ?></td>
                                                    <?php 
                     $montsupprabot=''  ;
                    $textsupprabot='';
                    ...
                    $montsuppsec= number_format($montsuppsec, 0, ',', ' ') .' Ar';?>
                                                    ...
                                                    <td style="text-align:right"><?php echo number_format($rowNLCS['MONTANT'], 0, ',', ' ') . " Ar" ?></td>
                                                </tr>
                                                <?php

                                                $VOLUMENLCS = $VOLUMENLCS + $rowNLCS['VOL'] * $rowNLCS['QTE_DV'];
                                                $suppNLCS = $suppNLCS + $montsuppsec*$rowNLCS['VOL'];
                                                                }
                                                                $sqlquery3NLCS = "SELECT  A.UNITE, sum((L.QTE_DV*A.QTE)*A.PV_HT) as 'THT', sum((L.QTE_DV*A.QTE)*A.PV_HT*(1+0.20)) as 'TTC', sum(A.VOL*L.QTE_DV) as 'VOLDV'
               from CONTENIR_DV L, ARTICLE A
               where L.ID_DV='$ID_DV' AND A.ID_A=L.ID_A AND A.UNITE='$unite' AND A.ID_TYPE='$type1'";
                                                                $result3NLCS = mysqli_query($link, $sqlquery3NLCS);
                                                                $row3NLCS = mysqli_fetch_array($result3NLCS, MYSQLI_ASSOC);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($suppNLCS, 0, ',', ' ') . " Ar" ?></strong></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="6" class="success"><strong>Total</strong></td>
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($VOLUMENLCS, 3, ',', ' ') ?></strong></td>
                                                                    <td></td>
                                                                    <td class="" style="text-align:right"><strong><?php echo number_format($row3NLCS['THT'] + $suppNLCS, 0, ',', ' ') . " Ar" ?></strong></td>
                                                                </tr>
                                                        </table>
                                                        <?php
