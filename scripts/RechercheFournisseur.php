...
$link=$retour[0];
  ...
  <div id="tabs-1">
   <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <form name="form1" method="post" action="RechercheFournisseurResultat.php" class="well3">
  ...
  <form name="form1" method="post" action="RechercheFournisseurResultat.php" class="well3">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-4">
      <input type="text" name="RAISSO_F" id="texte" class="form-control" maxlength="30">
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-4">
      <input type="tel" name="CIN" id="texte" class="form-control " maxlength="10">
      </div>
     </div>
    </div><div class="row">
    <div class="form-group">
      ...
      <div class="col-xs-4">
      <input type="tel" name="NIF_F" id="texte" class="form-control " maxlength="10">
      </div>
      <label for="texte" class="col-xs-2">Stat.</label>
      <div class="col-xs-4">
      <input type="tel" name="STAT_F" id="texte" class="form-control " maxlength="10">
      </div>
     </div>
    </div>
        <div class="row">
